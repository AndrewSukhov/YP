package basicsJava.classesAndObjects.createAHamster.task5;
...
/*
    В прошлый раз вы описали класс конвертера валют Converter. Дополните код финансового приложения так,
    чтобы при запуске программы работала конвертация валют. Для этого потребуется создать конвертер-объект и вызвать его метод.
    В комментариях мы оставили подсказки: вам нужно сначала создать объект класса Converter, а потом вызвать его метод convert.
 */
